---
title: "AI Security Red Team Playbook: Test Before You Ship"
description: "45% of AI-generated code has vulnerabilities. 7 production attack vectors from prompt injection to tool poisoning. The CTO's pre-ship checklist."
date: "2026-03-15"
author: "Alex Mayhew"
...
In practice, teams routinely ship AI features through the same security review process they use for CRUD endpoints. That's insufficient. AI systems introduce fundamentally new attack vectors that require dedicated testing.
...
In practice, MCP configurations regularly ship where a "weather lookup" tool has filesystem access, a "calendar integration" tool can send arbitrary HTTP requests, and a "code formatting" tool has database write permissions. The permission model is inherited from the framework defaults... nobody reviews it.
...
**Need an AI security audit before shipping?** [Work with me](/contact) on your AI security architecture.
