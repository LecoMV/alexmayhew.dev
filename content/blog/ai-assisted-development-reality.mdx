---
title: "Stop Calling It Vibe Coding: What AI Development Requires"
description: "The AI coding discourse is split between two wrong camps. One says AI builds nothing real. The other says anyone ships overnight. Here's what it takes."
date: "2026-02-14"
author: "Alex Mayhew"
...
Where they are wrong is the conclusion. The implication that AI-assisted development is fundamentally incapable of producing professional-grade systems is contradicted by the evidence. Not theoretical evidence. Actual shipped systems. The productivity delta is real but asymmetric... see [the METR paradox](/blog/the-metr-paradox) for why senior engineers often slow down while juniors speed up.
...
None of that happened because I typed a single prompt and let the AI run. It happened because I brought 24 years of context to the conversation. The pattern matches what I covered in [cognitive debt from AI teams](/blog/cognitive-debt-ai-teams)... AI amplifies whatever judgment you already have, good or bad.
...
Remove competence and you get demo-quality code that breaks in production. Remove discipline and you get technical debt that compounds faster because AI helps you write more of it... the compounding pattern I documented in [the AI technical debt bomb](/blog/ai-technical-debt-bomb). Remove research and you get confident implementations of the wrong solution. Remove AI and you get the same results, slower.
