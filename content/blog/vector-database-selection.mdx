...
description: "Every SaaS adding AI faces the vector DB decision. pgvector, Pinecone, or Qdrant? The framework based on data scale, query patterns, and team capacity."
date: "2026-02-12"
author: "Alex Mayhew"
...
**Pricing note:** Pinecone migrated to a Read Unit (RU) model. A simple query against 1,000 vectors costs 1 RU. Metadata filtering increases cost to 5-10 RUs per query. At $16/M RUs (Standard plan), a simple 50K queries/day workload costs ~$24/month for reads alone. The old per-query pricing is no longer accurate... check [Pinecone's cost calculator](https://www.pinecone.io/pricing/) for your specific workload.
