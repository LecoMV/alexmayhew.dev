...
const stream = client.query(copyFrom(
  `COPY items (id, name, tenant_id, created_at) FROM STDIN WITH CSV`
));
...
*Building a SaaS and hitting database performance walls? I help teams architect systems that scale from MVP to 100k+ users. [Let's talk about your technical challenges](/services/nextjs-developer-for-saas).*
