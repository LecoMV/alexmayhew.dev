...
In practice, I've started calling this "phantom velocity." The sprint velocity chart looks great. PRs are merging faster. Lines of code are up. But the maintenance burden in months 6-18 is 3-4x what the team budgeted for, because nobody factored in the cost of understanding, debugging, and eventually rewriting code that was generated rather than designed.
...
In practice, this shows up as modules that nobody wants to touch. I call them "frozen zones"... sections of the codebase where the team routes around problems rather than fixing them because the cost of understanding the code exceeds the cost of building a workaround. Most AI-heavy codebases now carry at least 3-5 frozen zones that didn't exist 18 months ago.
...
Most teams resist the "ai_unreviewed" category. Use it anyway. The point isn't blame... it's risk mapping. Teams routinely underestimate the percentage of AI-generated code they merge without deep review by ~40%. The label forces honesty.
...
**Need an AI debt audit for your engineering org?** [Work with me](/contact) on building a measurement-driven remediation strategy.
