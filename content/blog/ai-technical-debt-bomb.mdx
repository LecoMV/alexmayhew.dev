...
description: "$1.5T projected AI-generated technical debt by 2027. GitClear shows 60% decline in refactoring, 8x increase in copy-paste code. Here's the audit checklist and remediation playbook."
date: "2026-03-15"
author: "Alex Mayhew"
...
```bash
# Calculate refactoring ratio from git history
# Refactors: commits touching existing files without adding new features
# New code: commits adding new files or significant new functionality
git log --since="3 months ago" --stat --oneline | \
  grep -c "files changed" # total changes
```
