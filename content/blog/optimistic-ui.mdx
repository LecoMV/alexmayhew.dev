...
<TodoItem
  todo={todo}
  pending={todo.id.startsWith('temp-')}
/>
```
...
*This is part of a series on building production SaaS applications. Next up: [The Designer-Developer Handoff: From Friction to Flow](/blog/designer-developer-handoff).*
