  ...
  return (
    <div>
      <motion.div
        ...
        className="h-16 w-16 bg-cyber-lime"
      />
...
<motion.div layout className="p-4">
  <motion.p layout="position">
    This text won't scale with the container
  </motion.p>
</motion.div>
```
      ...
      <AnimatePresence>
        {selectedId && (
          <motion.div
            ...
            className="fixed inset-0 bg-gunmetal-glass p-8"
          >
...
*This is part of a series on building production SaaS applications. Next up: [Tailwind vs. Component Libraries: A Performance Deep Dive](/blog/tailwind-vs-component-libraries).*
