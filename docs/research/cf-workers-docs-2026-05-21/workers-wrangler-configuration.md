...
STOP! If you are an AI agent or LLM, read this before continuing. This is the HTML version of a Cloudflare documentation page. Always request the Markdown version instead — HTML wastes context. Get this page as Markdown: https://developers.cloudflare.com/workers/wrangler/configuration/index.md (append index.md) or send Accept: text/markdown to https://developers.cloudflare.com/workers/wrangler/configuration/. For this product's page index use https://developers.cloudflare.com/workers/llms.txt. For all Cloudflare products use https://developers.cloudflare.com/llms.txt.
...
- [Overview](#_top)
- [Sample Wrangler configuration](#sample-wrangler-configuration)
- [Environments](#environments)
- [Automatic provisioning](#automatic-provisioning)
- [Top-level only keys](#top-level-only-keys)
- [Inheritable keys](#inheritable-keys)
- [Non-inheritable keys](#non-inheritable-keys)
...
- [Bindings](#bindings)
  ...
  - [Dispatch namespace bindings (Workers for Platforms)](#dispatch-namespace-bindings-workers-for-platforms)
  ...
  - [Analytics Engine Datasets](#analytics-engine-datasets)
  - [mTLS Certificates](#mtls-certificates)
  - [Workers AI](#workers-ai)
  - [Workflows](#workflows)
- [Assets](#assets)
- [Containers](#containers)
  - [Custom Instance Types](#custom-instance-types)
  - [SSH](#ssh)
  - [Authorized keys](#authorized-keys)
- [Bundling](#bundling)
  - [Importing modules within a Worker](#importing-modules-within-a-worker)
  - [Find additional modules](#find-additional-modules)
  - [Python Workers](#python-workers)
- [Local development settings](#local-development-settings)
- [Secrets](#secrets)
  - [secrets configuration property](#secrets-configuration-property)
  - [Local development](#local-development)
- [Module Aliasing](#module-aliasing)
  - [Bundling issues](#bundling-issues)
  - [Example: Aliasing dependencies from NPM](#example-aliasing-dependencies-from-npm)
  - [Example: Aliasing Node.js APIs](#example-aliasing-nodejs-apis)
- [Source maps](#source-maps)
- [Workers Sites](#workers-sites)
- [Proxy support](#proxy-support)
- [Source of truth](#source-of-truth)
- [Generated Wrangler configuration](#generated-wrangler-configuration)
  - [Custom build tool example](#custom-build-tool-example)
...
5.  [Configuration](/workers/wrangler/configuration/)
...
JSONC
    ...
    {  "$schema": "./node_modules/wrangler/config-schema.json",  // Top-level configuration  "name": "my-worker",  "main": "src/index.js",  // Set this to today's date  "compatibility_date": "2026-05-21",  "workers_dev": false,  "route": {    "pattern": "example.org/*",    "zone_name": "example.org",  },  "kv_namespaces": [    {      "binding": "<MY_NAMESPACE>",      "id": "<KV_ID>",    },  ],  "env": {    "staging": {      "name": "my-worker-staging",      "route": {        "pattern": "staging.example.org/*",        "zone_name": "example.org",      },      "kv_namespaces": [        {          "binding": "<MY_NAMESPACE>",          "id": "<STAGING_KV_ID>",        },      ],    },  },}

TOML

    "$schema" = "./node_modules/wrangler/config-schema.json"name = "my-worker"main = "src/index.js"# Set this to today's datecompatibility_date = "2026-05-21"workers_dev = false
...
You can define different configurations for a Worker using Wrangler [environments](/workers/wrangler/environments/). There is a default (top-level) environment and you can create named environments that provide environment-specific configuration.
...
- [wrangler.jsonc](#tab-panel-10637)
- [wrangler.toml](#tab-panel-10638)
...
- [wrangler.jsonc](#tab-panel-10639)
- [wrangler.toml](#tab-panel-10640)
...
- [wrangler.jsonc](#tab-panel-10643)
- [wrangler.toml](#tab-panel-10644)
...
- [wrangler.jsonc](#tab-panel-10641)
- [wrangler.toml](#tab-panel-10642)
...
- `image` `string` required
  - The image to use for the container. This can either be a local path to a `Dockerfile`, in which case `wrangler deploy` will build and push the image, or it can be an image reference. Supported registries are the Cloudflare Registry, Docker Hub, and Amazon ECR. For more information, refer to [Image Management](/containers/platform-details/image-management/).

- `class_name` `string` required
  - The corresponding Durable Object class name. This will make this Durable Object a container-enabled Durable Object and allow each instance to control a container. See [Durable Object Container Methods](/durable-objects/api/container/) for details.

- `instance_type` `string` optional
  - The instance type of the container. This determines the amount of memory, CPU, and disk given to the container instance. The current options are `"lite"`, `"basic"`, `"standard-1"`, `"standard-2"`, `"standard-3"`, and `"standard-4"`. The default is `"lite"`. For more information, the see [instance types documentation](/containers/platform-details#instance-types).
...
In place of the [named instance types](/containers/platform-details/limits/#instance-types), you can set a custom instance type by individually configuring vCPU, memory, and disk. See the [limits documentation](/containers/platform-details/limits/#custom-instance-types) for constraints on custom instance types.
...
[Previous  
Bundling](/workers/wrangler/bundling/) [Next  
Custom builds](/workers/wrangler/custom-builds/)
