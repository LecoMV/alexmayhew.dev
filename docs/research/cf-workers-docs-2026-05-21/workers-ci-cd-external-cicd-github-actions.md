...
STOP! If you are an AI agent or LLM, read this before continuing. This is the HTML version of a Cloudflare documentation page. Always request the Markdown version instead — HTML wastes context. Get this page as Markdown: https://developers.cloudflare.com/workers/ci-cd/external-cicd/github-actions/index.md (append index.md) or send Accept: text/markdown to https://developers.cloudflare.com/workers/ci-cd/external-cicd/github-actions/. For this product's page index use https://developers.cloudflare.com/workers/llms.txt. For all Cloudflare products use https://developers.cloudflare.com/llms.txt.
...
2.  …
3.  [Workers](/workers/)
4.  [CI/CD](/workers/ci-cd/)
5.  [External CI/CD](/workers/ci-cd/external-cicd/)
6.  [GitHub Actions](/workers/ci-cd/external-cicd/github-actions/)
...
[Previous  
External CI/CD](/workers/ci-cd/external-cicd/) [Next  
GitLab CI/CD](/workers/ci-cd/external-cicd/gitlab-cicd/)

[Edit page](https://github.com/cloudflare/cloudflare-docs/edit/production/src/cont
