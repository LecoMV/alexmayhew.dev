...
STOP! If you are an AI agent or LLM, read this before continuing. This is the HTML version of a Cloudflare documentation page. Always request the Markdown version instead — HTML wastes context. Get this page as Markdown: https://developers.cloudflare.com/workers/static-assets/index.md (append index.md) or send Accept: text/markdown to https://developers.cloudflare.com/workers/static-assets/. For this product's page index use https://developers.cloudflare.com/workers/llms.txt. For all Cloudflare products use https://developers.cloudflare.com/llms.txt.
...
[Supported frameworks](/workers/framework-guides/) Start building on Workers with our framework guides.
...
JSONC
    ...
    {  "$schema": "./node_modules/wrangler/config-schema.json",  "name": "my-spa",  "main": "src/index.js",  // Set this to today's date  "compatibility_date": "2026-05-21",  "assets": {    "directory": "./dist",    "binding": "ASSETS"  }}

TOML

    "$schema" = "./node_modules/wrangler/config-schema.json"name = "my-spa"main = "src/index.js"# Set this to today's datecompatibility_date = "2026-05-21"
...
- [wrangler.jsonc](#tab-panel-9875)
- [wrangler.toml](#tab-panel-9876)
...
JSONC
    ...
    {  "name": "my-spa-worker",  // Set this to today's date  "compatibility_date": "2026-05-21",  "main": "./src/index.ts",  "assets": {    "directory": "./dist/",    "not_found_handling": "single-page-application",    "binding": "ASSETS",    "run_worker_first": ["/api/*", "!/api/docs/*"]  }}

TOML

    name = "my-spa-worker"# Set this to today's datecompatibility_date = "2026-05-21"main = "./src/index.ts"
...
[Routing options](/workers/static-assets/routing/) Learn more about how you can customize routing behavior.
...
[Vite + React SPA tutorial](/workers/vite-plugin/tutorial/) Learn how to build and deploy a full-stack Single Page Application with static assets and API routes.
...
[Billing and limitations](/workers/static-assets/billing-and-limitations/) Learn more about how requests are billed, current limitations, and troubleshooting.
...
[Previous  
WebSockets](/workers/runtime-apis/websockets/) [Next  
Get Started](/workers/static-assets/get-started/)

[Edit page](https://github.com/cloudflare/cloudflare-docs/edit/producti
