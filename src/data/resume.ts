...
export const resumeRoles: ResumeRole[] = [
	...
	},
	{
		...
		bullets: [
			...
			"Provision, harden, and operate production Linux servers — nginx, systemd, fail2ban/AppArmor/auditd, automated off-site backups (restic to Cloudflare R2), Prometheus/Grafana monitoring — documented as reproducible install-and-verify runbooks.",
...
export const resumeEducation =
	"Self-taught in programming, web design, and IT since age 14 — still how I pick up new tools. High school diploma.";
