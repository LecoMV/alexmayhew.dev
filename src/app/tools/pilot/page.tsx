...
export default function ClaudePilotPage() {
	return (
		<>
			<SoftwareJsonLd
				name="Claude Pilot"
				description="All-in-one management app for Claude Code workflows. Session monitoring, memory browser, MCP server configuration, and integrated terminal."
				url="/tools/pilot"
					...
					<header className="mb-12">
						<div className="mb-4 flex items-center gap-3">
							...
							<div className="flex items-center gap-2">
								<span className="border-signal-info/50 text-signal-info text-micro border px-2 py-0.5 font-mono tracking-wider uppercase">
									Download
								</span>
