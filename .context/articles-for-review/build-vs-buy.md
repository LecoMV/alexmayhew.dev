...
Auth from scratch: 6 weeks + ongoing security patches. Auth0: $0.02/MAU and 1 day integration. Billing from scratch: 3 months + tax compliance nightmares. Stripe: 2.9% + $0.30. The true cost = (engineer salary × time) + maintenance + opportunity cost. Every hour on infrastructure is an hour not on product.
...
Clerk costs approximately $0.02/MAU. At 10,000 users: $200/month = $7,200 over 3 years.
...
_This is part of a series on building production SaaS applications. Next up: [Why Boring Technology Wins: Lessons from Unicorn Migrations](/blog/boring-technology-wins)._
